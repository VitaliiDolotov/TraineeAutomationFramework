...
Scenario: CheckThatNewAddressCanBeAdded
	...
	When User enters '446 Noah Ct' text to 'Street Address' input
	When User enters 'Westminster' text to 'City' input
	When User enters 'MD' text to 'State' input
	When User enters '21157' text to 'Zip Code' input
	When User clicks 'Create' button
	Then 'Users and Addresses' page is opened
	Then row with following data is displayed in 'Addresses' table
		| Column         | Data        |
		| Street Address | 446 Noah Ct |
		| City           | Westminster |
		| State          | MD          |
		| Zip Code       | 21157       |
# Data cleanup
